...
#task for LAB2
#-x to extrect the tar file
#-f to save file


wget -q -O ~/public_html/pics/pics.zip http://zonzorp.net/pics.tgz && tar -c ~/public_html/pics -x -z -f ~/public_html/pics/pics.tgz && rm ~/public_html/pics/pics.tgz
